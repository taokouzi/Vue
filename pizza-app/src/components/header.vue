  ...
  <div class="header">
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <ul class="navbar-nav">
    		...
    		<li><router-link :to="{ path:'/menu', query:{ gid: id } }" class="nav-link">菜单</router-link></li>
			<li><router-link to="/admin" class="nav-link">管理（需登录）</router-link></li>
			<li><router-link to='/about' class="nav-link">关于我们</router-link></li>
			<li><router-link to='/guard' class="nav-link">组件内守卫</router-link></li>
        </ul>
